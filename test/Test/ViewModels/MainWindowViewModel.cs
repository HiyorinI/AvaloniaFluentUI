...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    public string[] SegmentedItems { get; } = 
    [
        "Home",
        "GitHub",
        "Videos",
        "Segmented Item Requested",
        "Segmented Item Requested Theme",
        "Segmented Item Requested Theme Variant",
        "Segmented Item Requested Theme Variant Light",
        "Settings"
    ];
}
